  ...
  <div @click="store.filter_show = false" class="px-2">
    ...
    <section class="pt-4">
      ...
      <div v-show="store.PageProduct" class="w-full max-w-screen">
        ...
        >
          <h1 class="text-blue-700 font-bold text-lg w-full">To'lovlar</h1>
          <div class="w-full flex items-center lg:pb-0 pb-2 gap-5 justify-end">
            ...
            >
              ...
              <button
                ...
                class="btnAdd flex items-center max-w-fit justify-center whitespace-nowrap text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
              >
                <span class="">To'lov tarixini ko'rish</span>
              </button>
            </div>
          </div>
        </div>
            ...
            <table class="w-full text-sm text-left">
              ...
              >
                <tr>
                  ...
                  <th scope="col" class="text-center py-3">To'langan summa</th>
              ...
              <tbody v-show="!store.error">
                ...
                >
                  ...
                  <td class="text-center font-medium text-bKeldilue-800 px-8 py-2">
                    <button
                      class="btnAdd text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
                    >
                      To'lov qilish
                    </button>
                  </td>
